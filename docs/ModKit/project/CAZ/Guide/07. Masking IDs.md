...
**Clothing Masking ID List**

| Clothing Masking ID | Group ID             | Composition                                           |
|---------------------|----------------------|-------------------------------------------------------|
...
**Body Masking ID List**

| Body Masking ID     | Group ID                 | Composition                                               |
|---------------------|--------------------------|------------------------------------------------------------|
...
[‹ Previous](06.%20Final%20Application.md){ .md-button .md-button--primary .prev-btn }