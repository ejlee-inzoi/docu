...
- Scans nearby game objects (furniture, doors, fixtures, etc.) relative to camera/pawn direction.
...
```js
await inzoi.cli.execute('entity.scan_objects', {
  radius: 0.0, // optional
  direction: '', // optional
  cone: 0.0, // optional
  sort: '', // optional
