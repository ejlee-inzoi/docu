...
## 🧩 Struct: FB1GarmentBottomTableRow

Data for bottoms displayed in the character customization garment list.  
This includes appearance, color channel settings, customization flags, and outfit tags.
...
- **IncompatibleBootsType** (`EB1BootsType`): Type of boots that are visually or logically incompatible with this bottom item.  
...
- [EB1BootsType](./Enum/EB1BootsType.md)
