...
## 🧩 Struct: FB1GarmentInnerUnderTableRow

Defines an inner undergarment (e.g., underwear, briefs) for character customization.  
Includes customization flags, color channels, variants, and outfit classification.
