...
## 🧩 Struct: FB1GarmentJacketTableRow

Defines a jacket garment for character customization.  
Includes customization flags, color channel support, variant definitions, and outfit category tagging.
