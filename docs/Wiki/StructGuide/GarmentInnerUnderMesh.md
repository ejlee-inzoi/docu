...
## 🧩 Struct: FB1GarmentInnerUnderMeshTableRow

Defines the mesh, material, and body region configuration for an inner undergarment, along with age/gender-specific remapping.
...
- **MatchingGenderId** (`TMap<EB1GenderType, FName>`): Gender-specific remapping IDs. *(Foreign = "GarmentInnerUnderMesh.Id")*  
- **MatchingBodyAgeId** (`TMap<EB1BodyAgeType, FName>`): Age-specific remapping IDs. *(Foreign = "GarmentInnerUnderMesh.Id")*  
