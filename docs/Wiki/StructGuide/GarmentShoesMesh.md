# 📘 GarmentShoesMesh Data Guide

## 🧩 Struct: FB1GarmentShoesMeshTableRow

Data for shoes mesh equipped on the character.  
Includes mesh configuration, material overrides, body region handling, and compatibility by age/gender.
...
- **FootType** (`EB1FootType`): Foot shape classification for the mesh (e.g., Flat, HighHeel).  
- **MatchingGenderId** (`TMap<EB1GenderType, FName>`): Gender-specific remapping IDs. *(Foreign = "GarmentShoesMesh.Id")*  
- **MatchingBodyAgeId** (`TMap<EB1BodyAgeType, FName>`): Age group-specific remapping IDs. *(Foreign = "GarmentShoesMesh.Id")*  


## 📚 References

- [EB1FootType](./Enum/EB1FootType.md)
