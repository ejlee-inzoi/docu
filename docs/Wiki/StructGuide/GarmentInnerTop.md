...
## 🧩 Struct: FB1GarmentInnerTopTableRow

Defines an inner top garment (e.g., camisole, undershirt) for character customization, including appearance variants and outfit classification.
