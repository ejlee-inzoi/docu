# 📘 GarmentTop Data Guide

## 🧩 Struct: FB1GarmentTopTableRow

Data for tops displayed in the character customization garment list.  
Supports customization, outfit filtering, and material-based enhancements.
