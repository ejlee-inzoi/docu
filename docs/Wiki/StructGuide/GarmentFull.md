...
## 🧩 Struct: FB1GarmentFullTableRow

Defines a one-piece (full-body) garment for character customization, including color customization, variants, and compatibility rules.
