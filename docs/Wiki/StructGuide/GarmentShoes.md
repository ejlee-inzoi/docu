# 📘 GarmentShoes Data Guide

## 🧩 Struct: FB1GarmentShoesTableRow

Data for shoes displayed in the character customization garment list.  
Includes customization options, outfit category tagging, and shoe-specific metadata.
